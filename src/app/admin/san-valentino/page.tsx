        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex flex-col gap-6 mb-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
              ...
              {/* SINISTRA: Pulsante Indietro + Testi */}
              ...
              <ArrowLeft size={20} className="text-slate-600"/>
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm font-medium mt-1">
                    Gestione Box San Valentino
                  </p>
                </div>
              </div>

              {/* DESTRA: Pulsanti Azioni (Logout, Stampa, Aggiorna) */}
              <div className="grid grid-cols-2 sm:flex gap-2">
                <button
                  onClick={handleLogout}
                  className="flex justify-center items-center gap-2 px-4 py-3 bg-white text-slate-700 border border-slate-200 rounded-xl hover:bg-red-50 hover:text-red-600 hover:border-red-200 font-bold shadow-sm text-sm transition-colors"
                >
                ...
                <button
                  onClick={handlePrint}
                  className="flex justify-center items-center gap-2 px-4 py-3 bg-slate-900 text-white border border-slate-900 rounded-xl hover:bg-slate-800 font-bold shadow-sm text-sm"
                >
                ...
                <button
                  onClick={fetchOrders}
                  className="col-span-2 sm:col-span-1 flex justify-center items-center gap-2 px-4 py-3 bg-blue-600 text-white border border-blue-600 rounded-xl hover:bg-blue-700 font-bold shadow-sm text-sm active:scale-95 transition-transform"
                >
